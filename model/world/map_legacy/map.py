...
from model.world.map_legacy.obstacle import Obstacle
...
class Map:
    ...
    def _add_obstacle(self, obstacle):
        # This varies based on the map_legacy implementation (spatial or not)
        pass
    ...
    def get_map(self, robots):
        ...
        # Backup the current map_legacy so that we can reset it later
